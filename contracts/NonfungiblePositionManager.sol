...
contract NonfungiblePositionManager is
    ...
    SelfPermit
{
    // details about the blasterswap position
    struct Position {
    ...
    ) ERC721Permit('Blasterswap V3 Positions NFT-V1', 'UNI-V3-POS', '1') PeripheryImmutableState(_factory, _WETH9) {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        PoolAddress.PoolKey memory poolKey = _poolIdToPoolKey[position.poolId];
        IBlasterswapV3Pool pool = IBlasterswapV3Pool(PoolAddress.computeAddress(factory, poolKey));
